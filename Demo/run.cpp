...
int main()
{
    ...
    const char *createTableSQL = "CREATE TABLE IF NOT EXISTS sample_table (id INTEGER PRIMARY KEY, name TEXT, age INTEGER);";
    ...
    // Insert sample data
    const char *insertDataSQL = "INSERT INTO sample_table (name, age) VALUES ('Alice', 30), ('Bob', 25), ('Charlie', 35);";
